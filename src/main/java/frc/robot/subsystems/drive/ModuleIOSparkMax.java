  ...
  public ModuleIOSparkMax(int index) {
    switch (index) {
      case 0: // FL
        ...
        absoluteEncoderOffset = new Rotation2d(1.3 + .0825);
        break;
      case 1: // FR
        ...
        absoluteEncoderOffset = new Rotation2d(-2.65 + .075);
        break;
      case 2: // BL
        ...
        absoluteEncoderOffset = new Rotation2d(-0.39 + .0825);
        break;
      case 3: // BR
        ...
        absoluteEncoderOffset = new Rotation2d(0.2 + .07325);
        break;
      default:
