...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  private final double DRIVE_GEAR_RATIO = (50.0 / 14.0) * (16.0 / 28.0) * (45.0 / 15.0); // L3 MK4i
  ...
  public ModuleIOTalonFX(int index) {
    switch (index) {
      case 0: // Front Left Module
        ...
        absoluteEncoderOffset = new Rotation2d(-2.17); // TODO MUST BE CALIBRATED
        break;
      case 1: // Front Right Module
        ...
        break;
      case 2: // Back Left Module
        driveTalon = new TalonFX(6);
        turnTalon = new TalonFX(5);
        cancoder = new CANcoder(11);
        absoluteEncoderOffset = new Rotation2d(2.75); // MUST BE CALIBRATED 2.75
        break;
      case 3: // Back Right Module
        driveTalon = new TalonFX(4);
        turnTalon = new TalonFX(3);
        cancoder = new CANcoder(10);
        absoluteEncoderOffset = new Rotation2d(-1.81); // MUST BE CALIBRATED
        break;
      default:
